...
function BackgroundCircles({}: Props) {
  return (
    <div className='relative flex justify-center items-center'>
        ...
        <div className= "rounded-full border border-[#333333]  h-[300px] w-[300px] mt-52 animate-ping " />
        <div className= "rounded-full border border-[#333333]  h-[500px] w-[500px] mt-52 animate-ping " />
