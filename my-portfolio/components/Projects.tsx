        ...
        <div className='relative w-full flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20'>
            {projects.map((project) => (
                <div className='w-screen flex-shrink-0 snap-center flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen'>
                    <img src="https://thumbs.dreamstime.com/b/homeless-man-bench-pop-art-vector-homeless-man-sleeps-bench-newspapers-pop-art-retro-vector-illustration-color-114550623.jpg" 
                    alt="" />
                   <div>
                        <h4>Homelessness in Texas</h4>
                    </div> 
                </div>
            ))}
        </div>
